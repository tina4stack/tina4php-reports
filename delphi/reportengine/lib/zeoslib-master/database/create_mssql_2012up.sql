...
(
   ...
   d_fld5                     	  smalldatetime    default '2003-12-11 23:12:11',
...
stTime                time null,
stTimestamp           datetime2 null,
stGUID                UNIQUEIDENTIFIER null,
stAsciiStream         varchar(max) null,
stUnicodeStream       nvarchar(max) null,
stBinaryStream        varbinary(max) null,
primary key (hl_id)
)
go
...
CREATE TABLE ADQA_All_types (
  ...
  tntext nvarchar(max) COLLATE Polish_CI_AS NULL,
  ...
  ttext varchar(max) COLLATE Polish_CI_AS NULL,
