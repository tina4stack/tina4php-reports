...
{$ENDIF}
  ...
  VCL.Dialogs, rptranslator, VCL.StdCtrls, VCL.ExtCtrls,rpmdrepclient,
  rpmdconsts, VCL.ActnList, VCL.ImgList, VCL.ComCtrls,rpparams,rpvgraphutils,
  rpgraphutilsvcl,
  rprfvparams, VCL.ToolWin, System.Actions, System.ImageList;
