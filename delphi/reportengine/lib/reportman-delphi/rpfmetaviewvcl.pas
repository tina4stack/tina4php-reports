...
uses
  ...
  Windows,VCL.Dialogs,rpgdidriver,ShellApi,rpgraphutilsvcl,rphtmldriver,
{$IFDEF USEVARIANTS}
  Types,Variants,
{$ENDIF}
  Classes, VCL.Graphics, VCL.Controls, VCL.Forms,
  VCL.StdCtrls,rpmetafile, VCL.ComCtrls,VCL.ExtCtrls,
{$IFDEF USEINDY}
  rpmdclitreevcl,
{$ENDIF}
  rpexceldriver,rptextdriver,rpsvgdriver,rpcsvdriver,
  VCL.ActnList, VCL.ImgList,VCL.Printers,rpmdconsts,rptypes, VCL.Menus,
  rpmdfaboutvcl,rpmdshfolder,rpmdprintconfigvcl,
  VCL.ToolWin, VCL.Mask, rpmaskedit,rpvgraphutils, System.ImageList, System.Actions,
